        ...
        <div className="flex justify-center items-center">
          <div className="w-full h-14 sm:h-20 flex flex-col justify-center bg-lightpink p-2 sm:p-3 rounded-lg shadow-md">
            <div className="tabs relative flex justify-center items-center h-full">
              ...
              <label className="tab h-full flex items-center justify-center peer-checked/radio-2:text-darkpink z-10 w-1/2 transition-all duration-200 sm:text-xl font-bold" htmlFor={`radio-2-${id}`}>利用方法</label>
