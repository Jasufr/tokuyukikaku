  ...
  return (
    <>
      <Helmet>
        ...
        />
        <meta property="og:image" content="/images/houmon.webp" />
      ...
      <div className="houmon relative">
        ...
        <div className="blobs w-full h-full absolute overflow-hidden -z-10">
          ...
          <div className="darkpink absolute top-80 -right-8 2md:right-2 w-48 xs:w-56 rotate-12">
            <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="px-6 2md:px-12 lg:px-24 xl:px-28 py-6 lg:py-12">
          <div className="flex items-center gap-2 sm:gap-5 2md:gap-10 mb-3 xs:mb-4">
            ...
            {/* <div aria-label="訪問介護　ご利用者様とヘルパーの写真" role="img" className="bg-[url('/images/houmon.webp')] bg-center bg-cover w-full h-14 sm:h-20 rounded-md shadow-md"></div> */}
          ...
          <Tabs visibleTab={visibleTab} setVisibleTab={setVisibleTab}>
            <div className={`shoukai ${visibleTab === "tab1" ? "block" : "hidden"} mt-4`}>
              <h2 className="mb-3 text-xl">訪問介護とは</h2>
              ...
              <div className="xs:flex gap-5 2md:gap-10 mt-4">
                <div className="xs:w-1/2 mb-4 xs:mb-0">
                  <h2 className="mb-3 text-xl">身体介護</h2>
                ...
                <div className="xs:w-1/2">
                  <h2 className="mb-3 text-xl">生活援助</h2>
            ...
            <div className={`riyou ${visibleTab === "tab2" ? "block" : "hidden"} mt-4`}>
              <h2 className="mb-3 text-xl">ご利用対象</h2>
              ...
              <p>※ご利用料金は、要介護度によって異なりますので、お客様の担当のケアマネジャー様とご相談ください。</p>
              <div className="mt-3">
              ...
              <div className="xs:flex gap-5 2md:gap-10">
                <div className="xs:w-1/2 mb-4 xs:mb-0">
                  <h2 className="mb-2 text-lg">介護認定を受けていない方</h2>
                ...
                <div className="xs:w-1/2">
                  <h2 className="mb-2 text-lg">介護認定を受けられていてご利用してない方</h2>
                  <ul className="list-square list-inside">
