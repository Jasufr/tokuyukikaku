    ...
    <>
      <div className="px-6 2md:px-12 lg:px-24 xl:px-28 py-6 lg:py-12">
        <div className="flex gap-10">
                  ...
                  <tr>
                    ...
                    <td className="bg-white p-2 border border-darkstone">
                      <ul>
                        ...
                        <li>★家庭環境等､考慮致します★直行直帰可</li>
                      </ul>
                    </td>
                  </tr>
                  <tr>
                    <th className="bg-lightpink border border-darkstone p-2 text-start" scope="row">対象となる方</th>
                    <td className="bg-white p-2 border border-darkstone" >･要普通自動車免許(AT限定可)･ヘルパー2級以上必須（経験は問いません､資格取得見込み者もご相談ください）･学歴不問</td>
                                    </tr>
                  <tr>
                    <th className="bg-lightpink border border-darkstone p-2 text-start" scope="row">特別手当</th>
                    <td className="bg-white p-2 border border-darkstone">弊社は東京都の介護職員処遇改善加算Ⅰ・介護職員等特定処遇改善加算Ⅱ及び介護職員ベースアップ等加算を取得しております。
                      処遇改善(特別手当)手当として、常勤ヘルパーは毎月66,000円～150,000円(経験及び勤務年数による)支給。
                      非常勤ヘルパーは訪問1件に付き300円支給。（自費利用の場合は、特別手当がつきません。）</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div className="w-2/5">
            <div className="bg-[url('./illustrations/helper2.jpg')] bg-cover bg-center h-1/3"></div>
            <div className="bg-[url('./illustrations/helper1.jpg')] bg-cover bg-center h-1/3"></div>
            <div className="bg-[url('./illustrations/helper3.jpg')] bg-cover bg-center h-1/3"></div>
          </div>
        </div>
      </div>
    </>
