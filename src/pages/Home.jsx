  ...
  return (
    <>
      <div className="home">
        ...
        <div>
          {/* About */}
          <div className="about-section relative my-12">
            <div className="flex gap-10 px-28 py-6">
          ...
          {/* Services */}
          <div className="services-section my-12 relative bg-lightgray bg-opacity-30">
            <div className="px-28 py-6">
              ...
              {/* Houmon service */}
              <div className="houmon flex gap-10 mb-6">
              ...
              <div className="taxi flex gap-10 mb-6">
                ...
                <div className="w-1/2 bg-[url('./images/kuruma2.jpg')] bg-center bg-cover rounded-md shadow-md min-h-[300px]"></div>
              </div>
              {/* Day service */}
              <div className="dayservice flex gap-10 mb-6">
                <div className="w-1/2 bg-[url('./images/dayservice1.jpg')] bg-bottom bg-cover rounded-md shadow-md min-h-[300px]"></div>
                <div className="w-1/2 flex flex-col justify-center">
              ...
              <div className="kyotaku flex gap-10">
                ...
                <div className="w-1/2 bg-darkstone bg-center bg-cover rounded-md shadow-md min-h-[300px]"></div>
              </div>
            </div>
          </div>
          {/* Feedback */}
          <div className="feedback flex gap-10 px-28 my-12 py-6">
            <div className="w-1/3">
            ...
            <div className="w-2/3 grid grid-cols-3 gap-2">
              <div className="flex justify-end max-w-72 h-40 bg-lightgray bg-opacity-40 p-2 rounded-md shadow-md">
          ...
          <div className="">
            <div className="flex h-96 relative mt-12 py-6">
              <div className="h-full w-1/3 bg-[url('./illustrations/helper2.jpg')] bg-cover bg-top"></div>
              <div className="h-full w-1/3 bg-[url('./illustrations/helper4.jpg')] bg-cover bg-top"></div>
              <div className="h-full w-1/3 bg-[url('./illustrations/helper3.jpg')] bg-cover bg-top"></div>
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col items-center">
                ...
                <div className="p-6 bg-white bg-opacity-70 rounded-full shadow-md w-52 hover:bg-black hover:bg-opacity-70 group transition-colors duration-200">
                  <h1 className="text-darkpink text-2xl text-center group-hover:text-lightpink transition-colors duration-200">採用情報</h1>
                </div>
              </div>
            </div>
          </div>
